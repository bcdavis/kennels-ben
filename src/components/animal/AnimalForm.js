    ...
    */
        ...
        */
        ...
        if (locationId === 0) {
            ...
            addAnimal({
                ...
                locationId, // if the value of this locationId has the same name, don't need to type out pair
                customerId
            })
            .then(() => history.push("/animals")) // push new location to our history array once it's added
        }
    }
    ...
    return (
        <form className="animalForm">
            ...
            <button type="submit" 
                onClick={evt => {
                    evt.preventDefault() // Prevent browser from submitting the form (can bypass this by setting type="button")
                    constructNewAnimal()
                }}
